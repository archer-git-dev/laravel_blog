                                    ...
                                    <div class="content">
                                        <form id="contact" action="{{ route('register') }}" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                    <fieldset>
                                                        <input name="re_password" type="password" id="password" placeholder="Repeat your password">
                                                    </fieldset>
                                                </div>
                                                <div class="col-lg-12">
                                                    <fieldset style="display: flex; align-items: center; justify-content: flex-start;">
                                                        <input style="width: auto; height: auto; margin: 0 10px;" type="checkbox" name="policy">
